...
iq_pubsub_owner(Host, ServerHost, From, IQType, SubEl, Lang) ->
	...
	[#xmlel{name = Name, attrs = Attrs, children = Els}] ->
		...
		_ ->
            ?DEBUG("
2017-02-24 09:31:27.891 [debug] <0.510.0>@ejabberd_receiver:process_data:284 Received XML on stream = <<60,105,113,32,105,100,61,34,70,50,70,51,53,48,57,67,48,67,49,69,52,67,51,67,65,52,54,53,55,54,67,52,49,52,68,52,50,69,67,50,34,32,116,121,112,101,61,34,115,101,116,34,62,60,113,117,101,114,121,32,120,109,108,110,115,61,34,106,97,98,98,101,114,58,105,113,58,114,111,115,116,101,114,34,32,62,60,105,116,101,109,32,106,105,100,61,34,49,50,49,48,52,56,64,97,98,45,105,110,115,117,114,97,110,99,101,46,99,111,109,34,32,110,97,109,101,61,34,34,62,32,60,109,101,115,115,97,103,101,62,230,136,145,230,152,175,229,186,158,230,172,163,60,47,109,101,115,115,97,103,101,62,60,103,114,111,117,112,62,230,136,145,231,154,132,229,165,189,229,143,139,60,47,103,114,111,117,112,62,60,47,105,116,101,109,62,60,47,113,117,101,114,121,62,60,47,105,113,62>>
2017-02-24 09:31:27.892 [debug] <0.510.0>@shaper:update:120 State: {maxrate,1000,152.96433040463378,1487899877440220}, Size=209
M=113.15428469542553, I=10451.851
2017-02-24 09:31:27.892 [debug] <0.511.0>@ejabberd_router:do_route:352 route
        from {jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
        to {jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}
        packet {xmlel,<<"iq">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"jid">>,<<"121048@ab-insurance.com">>},{<<"name">>,<<>>}],[{xmlcdata,<<" ">>},{xmlel,<<"message">>,[],[{xmlcdata,<<230,136,145,230,152,175,229,186,158,230,172,163>>}]},{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.892 [debug] <0.511.0>@ejabberd_router:do_route:376 773 From={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}, To={jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}, Packet={xmlel,<<"iq">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"jid">>,<<"121048@ab-insurance.com">>},{<<"name">>,<<>>}],[{xmlcdata,<<" ">>},{xmlel,<<"message">>,[],[{xmlcdata,<<230,136,145,230,152,175,229,186,158,230,172,163>>}]},{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.892 [debug] <0.511.0>@ejabberd_router:do_route:381 775 R={route,<<"ab-insurance.com">>,<<"ab-insurance.com">>,<0.348.0>,{apply,ejabberd_local,route}}
2017-02-24 09:31:27.892 [debug] <0.511.0>@ejabberd_local:do_route:266 local route
        from {jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
        to {jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}
        packet {xmlel,<<"iq">>,[{<<"xml:lang">>,<<"zh-C"...>>},{<<"id">>,<<...>>},{<<...>>,...}],[{xmlel,<<...>>,...}]}
2017-02-24 09:31:27.893 [debug] <0.511.0>@ejabberd_local:do_route:270 781 From={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},To={jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>},Packet={xmlel,<<"iq">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"jid">>,<<"121048@ab-insurance.com">>},{<<"name">>,<<>>}],[{xmlcdata,<<" ">>},{xmlel,<<"message">>,[],[{xmlcdata,<<230,136,145,230,152,175,229,186,158,230,172,163>>}]},{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.893 [debug] <0.511.0>@ejabberd_sm:do_route:466 session manager
        from {jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
        to {jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}
        packet {xmlel,<<"iq">>,[{<<"xml:lang">>,<<"zh-C"...>>},{<<"id">>,<<...>>},{<<...>>,...}],[{xmlel,<<...>>,...}]}
2017-02-24 09:31:27.893 [debug] <0.511.0>@ejabberd_sm:do_route:469 781 Packet={xmlel,<<"iq">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"jid">>,<<"121048@ab-insurance.com">>},{<<"name">>,<<>>}],[{xmlcdata,<<" ">>},{xmlel,<<"message">>,[],[{xmlcdata,<<230,136,145,230,152,175,229,186,158,230,172,163>>}]},{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.893 [debug] <0.511.0>@ejabberd_sm:process_iq:744 1001 IQ={iq,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>,set,<<"jabber:iq:roster">>,<<"zh-CN">>,{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"jid">>,<<"121048@ab-insurance.com">>},{<<"name">>,<<>>}],[{xmlcdata,<<" ">>},{xmlel,<<"message">>,[],[{xmlcdata,<<230,136,145,230,152,175,229,186,158,230,172,163>>}]},{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}}
2017-02-24 09:31:27.893 [debug] <0.511.0>@ejabberd_sm:process_iq:748 1002 XMLNS=<<"jabber:iq:roster">>, Host=<<"ab-insurance.com">>
2017-02-24 09:31:27.893 [debug] <0.446.0>@mod_roster:process_iq:147 ********2****: {iq,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>,set,<<"jabber:iq:roster">>,<<"zh-CN">>,{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"jid">>,<<"121048@ab-insurance.com">>},{<<"name">>,<<>>}],[{xmlcdata,<<" ">>},{xmlel,<<"message">>,[],[{xmlcdata,<<230,136,145,230,152,175,229,186,158,230,172,163>>}]},{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}}, 
2017-02-24 09:31:27.893 [debug] <0.446.0>@mod_roster:process_iq:150 1003 LServer=<<"ab-insurance.com">>,MYHOSTS=[<<"ab-insurance.com">>]
2017-02-24 09:31:27.894 [debug] <0.446.0>@mod_roster:process_iq:153 1005 From={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}, To={jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}, IQ={iq,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>,set,<<"jabber:iq:roster">>,<<"zh-CN">>,{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"jid">>,<<"121048@ab-insurance.com">>},{<<"name">>,<<>>}],[{xmlcdata,<<" ">>},{xmlel,<<"message">>,[],[{xmlcdata,<<230,136,145,230,152,175,229,186,158,230,172,163>>}]},{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}}
2017-02-24 09:31:27.894 [debug] <0.446.0>@mod_roster:try_process_iq_set:364 1006 Server=<<"ab-insurance.com">>,MODULE=mod_roster
2017-02-24 09:31:27.894 [debug] <0.446.0>@gen_mod:get_module_opt:292 1007 Module=mod_roster, Host=<<"ab-insurance.com">>, Opt=access, F=#Fun<mod_roster.21.47704033>, MODULE=all, OptsList=[{ejabberd_module,{mod_roster,<<"ab-insurance.com">>},[{db_type,sql}]}]
2017-02-24 09:31:27.894 [debug] <0.446.0>@gen_mod:get_opt:260 1008 Opt=access, Opts=[{db_type,sql}], F=#Fun<mod_roster.21.47704033>, Default=all
2017-02-24 09:31:27.894 [debug] <0.446.0>@mod_roster:try_process_iq_set:366 1009 Server=<<"ab-insurance.com">>,Access=all,From={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
2017-02-24 09:31:27.894 [debug] <0.446.0>@mod_roster:try_process_iq_set:372 1010 From={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},To={jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>},IQ={iq,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>,set,<<"jabber:iq:roster">>,<<"zh-CN">>,{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"jid">>,<<"121048@ab-insurance.com">>},{<<"name">>,<<>>}],[{xmlcdata,<<" ">>},{xmlel,<<"message">>,[],[{xmlcdata,<<230,136,145,230,152,175,229,186,158,230,172,163>>}]},{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}}
2017-02-24 09:31:27.894 [debug] <0.446.0>@mod_roster:process_iq_set:379 1011 Managed=false,Id=<<"F2F3509C0C1E4C3CA46576C414D42EC2">>
2017-02-24 09:31:27.894 [debug] <0.446.0>@mod_roster:process_item_set:391 1012 JID1={jid,<<"121048">>,<<"ab-insurance.com">>,<<>>,<<"121048">>,<<"ab-insurance.com">>,<<>>},User=<<"176926">>,LUser=<<"176926">>,LServer=<<"ab-insurance.com">>
2017-02-24 09:31:27.894 [debug] <0.446.0>@gen_mod:get_module_opt:292 1007 Module=mod_roster, Host=<<"ab-insurance.com">>, Opt=db_type, F=#Fun<mod_roster.51.47704033>, MODULE=undefined, OptsList=[{ejabberd_module,{mod_roster,<<"ab-insurance.com">>},[{db_type,sql}]}]
2017-02-24 09:31:27.894 [debug] <0.446.0>@gen_mod:get_opt:260 1008 Opt=db_type, Opts=[{db_type,sql}], F=#Fun<mod_roster.51.47704033>, Default=undefined
2017-02-24 09:31:27.895 [debug] <0.376.0>@ejabberd_sql:sql_query_internal:571 SQL: "begin;"
2017-02-24 09:31:27.899 [debug] <0.376.0>@gen_mod:get_module_opt:292 1007 Module=mod_roster, Host=<<"ab-insurance.com">>, Opt=db_type, F=#Fun<mod_roster.51.47704033>, MODULE=undefined, OptsList=[{ejabberd_module,{mod_roster,<<"ab-insurance.com">>},[{db_type,sql}]}]
2017-02-24 09:31:27.900 [debug] <0.376.0>@gen_mod:get_opt:260 1008 Opt=db_type, Opts=[{db_type,sql}], F=#Fun<mod_roster.51.47704033>, Default=undefined
2017-02-24 09:31:27.900 [debug] <0.376.0>@mod_roster:get_roster_by_jid_t:359 1013 Mod=mod_roster_sql
2017-02-24 09:31:27.900 [debug] <0.376.0>@ejabberd_sql:sql_query_t:183 1022 Query={sql_query,<<"Q5090831">>,#Fun<sql_queries.73.110939458>,#Fun<sql_queries.74.110939458>,#Fun<sql_queries.75.110939458>,{sql_queries,403}}
2017-02-24 09:31:27.900 [debug] <0.376.0>@ejabberd_sql:sql_query_internal:571 SQL: "select username, jid, sub, ask, recv, nick from ofroster where username='176926' and jid='121048@ab-insurance.com'"
2017-02-24 09:31:27.901 [debug] <0.376.0>@mod_roster_sql:get_roster_by_jid:89 1027 Res=[]
2017-02-24 09:31:27.902 [debug] <0.376.0>@gen_mod:get_module_opt:292 1007 Module=mod_shared_roster, Host=<<"ab-insurance.com">>, Opt=db_type, F=#Fun<mod_shared_roster.37.16060394>, MODULE=undefined, OptsList=[{ejabberd_module,{mod_shared_roster,<<"ab-insurance.com">>},[]}]
2017-02-24 09:31:27.902 [debug] <0.376.0>@gen_mod:get_opt:260 1008 Opt=db_type, Opts=[], F=#Fun<mod_shared_roster.37.16060394>, Default=undefined
2017-02-24 09:31:27.902 [debug] <0.376.0>@gen_mod:get_module_opt:292 1007 Module=mod_shared_roster, Host=<<"ab-insurance.com">>, Opt=db_type, F=#Fun<mod_shared_roster.37.16060394>, MODULE=undefined, OptsList=[{ejabberd_module,{mod_shared_roster,<<"ab-insurance.com">>},[]}]
2017-02-24 09:31:27.902 [debug] <0.376.0>@gen_mod:get_opt:260 1008 Opt=db_type, Opts=[], F=#Fun<mod_shared_roster.37.16060394>, Default=undefined
2017-02-24 09:31:27.902 [debug] <0.376.0>@mod_roster:process_item_set:403 1009 Item={roster,{<<"176926">>,<<"ab-insurance.com">>,{<<"121048">>,<<"ab-insurance.com">>,<<>>}},{<<"176926">>,<<"ab-insurance.com">>},{<<"121048">>,<<"ab-insurance.com">>,<<>>},<<>>,none,none,[],<<>>,[]},Item1={roster,{<<"176926">>,<<"ab-insurance.com">>,{<<"121048">>,<<"ab-insurance.com">>,<<>>}},{<<"176926">>,<<"ab-insurance.com">>},{<<"121048">>,<<"ab-insurance.com">>,<<>>},<<>>,none,none,[],<<>>,[]},Item2={roster,{<<"176926">>,<<"ab-insurance.com">>,{<<"121048">>,<<"ab-insurance.com">>,<<>>}},{<<"176926">>,<<"ab-insurance.com">>},{<<"121048">>,<<"ab-insurance.com">>,<<>>},<<>>,none,none,[<<230,136,145,231,154,132,229,165,189,229,143,139>>],<<>>,[]},Item3={roster,{<<"176926">>,<<"ab-insurance.com">>,{<<"121048">>,<<"ab-insurance.com">>,<<>>}},{<<"176926">>,<<"ab-insurance.com">>},{<<"121048">>,<<"ab-insurance.com">>,<<>>},<<>>,none,none,[<<230,136,145,231,154,132,229,165,189,229,143,139>>],<<>>,[]},Item3#roster.subscription=none
2017-02-24 09:31:27.903 [debug] <0.376.0>@gen_mod:get_module_opt:292 1007 Module=mod_roster, Host=<<"ab-insurance.com">>, Opt=db_type, F=#Fun<mod_roster.51.47704033>, MODULE=undefined, OptsList=[{ejabberd_module,{mod_roster,<<"ab-insurance.com">>},[{db_type,sql}]}]
2017-02-24 09:31:27.903 [debug] <0.376.0>@gen_mod:get_opt:260 1008 Opt=db_type, Opts=[{db_type,sql}], F=#Fun<mod_roster.51.47704033>, Default=undefined
2017-02-24 09:31:27.903 [debug] <0.376.0>@mod_roster:update_roster_t:821 1013 Mod=mod_roster_sql, LUser=<<"176926">>, LServer=<<"ab-insurance.com">>, LJID={<<"121048">>,<<"ab-insurance.com">>,<<>>}, Item={roster,{<<"176926">>,<<"ab-insurance.com">>,{<<"121048">>,<<"ab-insurance.com">>,<<>>}},{<<"176926">>,<<"ab-insurance.com">>},{<<"121048">>,<<"ab-insurance.com">>,<<>>},<<>>,none,none,[<<230,136,145,231,154,132,229,165,189,229,143,139>>],<<>>,[]}
2017-02-24 09:31:27.903 [debug] <0.376.0>@mod_roster_sql:record_to_row:326 1015 Subscription=none
2017-02-24 09:31:27.903 [debug] <0.376.0>@mod_roster_sql:record_to_row:349 1016 LUser=<<"176926">>, SJID=<<"121048@ab-insurance.com">>, Name2=[], SSubscription=0, SAsk=-1, AskMessage2=[]
2017-02-24 09:31:27.903 [debug] <0.376.0>@sql_queries:update_roster:446 1010 ItemGroups=[<<230,136,145,231,154,132,229,165,189,229,143,139>>], ItemVals={<<"176926">>,<<"121048@ab-insurance.com">>,[],0,-1,[]}
2017-02-24 09:31:27.903 [debug] <0.376.0>@ejabberd_sql:sql_query_internal:571 SQL: "select to_char(count(rosterid)) from ofRoster where username='176926' and jid='121048@ab-insurance.com'"
2017-02-24 09:31:27.905 [debug] <0.376.0>@ejabberd_sql:sql_query_internal:571 SQL: "select to_char(max(rosterid)) from ofRoster "
2017-02-24 09:31:27.907 [debug] <0.376.0>@sql_queries:roster_subscribe:529 1020 MaxRosterId=4603
2017-02-24 09:31:27.907 [debug] <0.376.0>@sql_queries:roster_subscribe:534 1019 MaxRosterId2=4604,LUser2="'176926'", SJID2="'121048@ab-insurance.com'", Nick2=<<>>, SSub=0, SAsk=-1
2017-02-24 09:31:27.907 [debug] <0.376.0>@ejabberd_sql:sql_query_internal:571 SQL: "insert into ofRoster(rosterid, username, jid, sub, ask, recv, nick) values (4604, '176926', '121048@ab-insurance.com', 0, -1, -1, '')"
2017-02-24 09:31:27.916 [debug] <0.376.0>@sql_queries:roster_subscribe:539 1020 Res1={updated,1}
2017-02-24 09:31:27.916 [debug] <0.376.0>@gen_mod:get_module_opt:292 1007 Module=mod_roster, Host=<<"ab-insurance.com">>, Opt=managers, F=#Fun<mod_roster.47.47704033>, MODULE=[], OptsList=[{ejabberd_module,{mod_roster,<<"ab-insurance.com">>},[{db_type,sql}]}]
2017-02-24 09:31:27.917 [debug] <0.376.0>@gen_mod:get_opt:260 1008 Opt=managers, Opts=[{db_type,sql}], F=#Fun<mod_roster.47.47704033>, Default=[]
2017-02-24 09:31:27.917 [debug] <0.376.0>@gen_mod:get_module_opt:292 1007 Module=mod_roster, Host=<<"ab-insurance.com">>, Opt=store_current_id, F=#Fun<mod_roster.9.47704033>, MODULE=false, OptsList=[{ejabberd_module,{mod_roster,<<"ab-insurance.com">>},[{db_type,sql}]}]
2017-02-24 09:31:27.917 [debug] <0.376.0>@gen_mod:get_opt:260 1008 Opt=store_current_id, Opts=[{db_type,sql}], F=#Fun<mod_roster.9.47704033>, Default=false
2017-02-24 09:31:27.917 [debug] <0.376.0>@ejabberd_sql:sql_query_internal:571 SQL: "commit;"
2017-02-24 09:31:27.918 [debug] <0.446.0>@ejabberd_sm:do_route:461 sending to process <0.511.0>
2017-02-24 09:31:27.918 [debug] <0.446.0>@gen_mod:get_module_opt:292 1007 Module=mod_roster, Host=<<"ab-insurance.com">>, Opt=versioning, F=#Fun<mod_roster.8.47704033>, MODULE=false, OptsList=[{ejabberd_module,{mod_roster,<<"ab-insurance.com">>},[{db_type,sql}]}]
2017-02-24 09:31:27.918 [debug] <0.446.0>@gen_mod:get_opt:260 1008 Opt=versioning, Opts=[{db_type,sql}], F=#Fun<mod_roster.8.47704033>, Default=false
2017-02-24 09:31:27.918 [debug] <0.511.0>@ejabberd_c2s:handle_info:1428 broadcast
{item,{<<"121048">>,<<"ab-insurance.com">>,<<>>},none}
2017-02-24 09:31:27.918 [debug] <0.511.0>@ejabberd_c2s:roster_change:2364 roster changed for <<"176926">>
2017-02-24 09:31:27.919 [debug] <0.446.0>@ejabberd_router:do_route:352 route
        from {jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}
        to {jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
        packet {xmlel,<<"iq">>,[{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.919 [debug] <0.446.0>@ejabberd_router:do_route:376 773 From={jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}, To={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}, Packet={xmlel,<<"iq">>,[{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.919 [debug] <0.446.0>@ejabberd_router:do_route:381 775 R={route,<<"ab-insurance.com">>,<<"ab-insurance.com">>,<0.348.0>,{apply,ejabberd_local,route}}
2017-02-24 09:31:27.919 [debug] <0.446.0>@ejabberd_local:do_route:266 local route
        from {jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}
        to {jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
        packet {xmlel,<<"iq">>,[{<<"id">>,<<"push"...>>},{<<"type">>,<<...>>}],[{xmlel,<<...>>,...}]}
2017-02-24 09:31:27.919 [debug] <0.446.0>@ejabberd_local:do_route:270 781 From={jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>},To={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},Packet={xmlel,<<"iq">>,[{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.920 [debug] <0.446.0>@ejabberd_sm:do_route:466 session manager
        from {jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}
        to {jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
        packet {xmlel,<<"iq">>,[{<<"id">>,<<"push"...>>},{<<"type">>,<<...>>}],[{xmlel,<<...>>,...}]}
2017-02-24 09:31:27.920 [debug] <0.446.0>@ejabberd_sm:do_route:469 781 Packet={xmlel,<<"iq">>,[{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.920 [debug] <0.446.0>@ejabberd_sm:do_route:592 sending to process <0.511.0>
2017-02-24 09:31:27.920 [debug] <0.446.0>@ejabberd_router:do_route:352 route
        from {jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}
        to {jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
        packet {xmlel,<<"iq">>,[{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}],[]}
2017-02-24 09:31:27.920 [debug] <0.446.0>@ejabberd_router:do_route:376 773 From={jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}, To={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}, Packet={xmlel,<<"iq">>,[{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}],[]}
2017-02-24 09:31:27.920 [debug] <0.446.0>@ejabberd_router:do_route:381 775 R={route,<<"ab-insurance.com">>,<<"ab-insurance.com">>,<0.348.0>,{apply,ejabberd_local,route}}
2017-02-24 09:31:27.920 [debug] <0.511.0>@ejabberd_c2s:handle_info:1477 783 From={jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>},To={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},Packet={xmlel,<<"iq">>,[{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.920 [debug] <0.446.0>@ejabberd_local:do_route:266 local route
        from {jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}
        to {jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
        packet {xmlel,<<"iq">>,[{<<"id">>,<<"F2F3"...>>},{<<"type">>,<<...>>}],[]}
2017-02-24 09:31:27.920 [debug] <0.446.0>@ejabberd_local:do_route:270 781 From={jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>},To={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},Packet={xmlel,<<"iq">>,[{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}],[]}
2017-02-24 09:31:27.921 [debug] <0.446.0>@ejabberd_sm:do_route:466 session manager
        from {jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}
        to {jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
        packet {xmlel,<<"iq">>,[{<<"id">>,<<"F2F3"...>>},{<<"type">>,<<...>>}],[]}
2017-02-24 09:31:27.921 [debug] <0.446.0>@ejabberd_sm:do_route:469 781 Packet={xmlel,<<"iq">>,[{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}],[]}
2017-02-24 09:31:27.921 [debug] <0.446.0>@ejabberd_sm:do_route:592 sending to process <0.511.0>
2017-02-24 09:31:27.921 [debug] <0.511.0>@ejabberd_c2s:handle_info:1731 785 Pass=true, NewAttrs=[{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}], NewState={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[],[]},1000,undefined,300000,300,60000,undefined,false,13,17,16,true,<<"zh-CN">>}
2017-02-24 09:31:27.922 [debug] <0.511.0>@ejabberd_c2s:handle_info:1742 786 NewState={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[],[]},1000,undefined,300000,300,60000,undefined,false,13,17,16,true,<<"zh-CN">>}, FixedPacket={xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.922 [debug] <0.511.0>@ejabberd_c2s:send_packet:1995 788 StateData={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[],[]},1000,undefined,300000,300,60000,undefined,false,13,17,16,true,<<"zh-CN">>},Packet={xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.923 [debug] <0.511.0>@ejabberd_c2s:send_stanza:1981 793 StateData={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[],[]},1000,undefined,300000,300,60000,undefined,false,13,17,16,true,<<"zh-CN">>},Stanza={xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.924 [debug] <0.511.0>@ejabberd_c2s:send_element:1969 796 StateData={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[{18,{1487,899887,923382},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}}],[]},1000,undefined,300000,300,60000,undefined,false,13,18,16,true,<<"zh-CN">>}, El={xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}
2017-02-24 09:31:27.928 [debug] <0.511.0>@ejabberd_c2s:send_text:1948 797 StateData#state.sockmod=ejabberd_socket, StateData#state.socket={socket_state,gen_tcp,#Port<0.17740>,<0.510.0>}, Text=<<60,105,113,32,102,114,111,109,61,39,49,55,54,57,50,54,64,97,98,45,105,110,115,117,114,97,110,99,101,46,99,111,109,39,32,116,111,61,39,49,55,54,57,50,54,64,97,98,45,105,110,115,117,114,97,110,99,101,46,99,111,109,47,72,105,115,117,112,101,114,39,32,105,100,61,39,112,117,115,104,55,50,53,49,52,57,50,52,55,56,51,55,50,48,57,52,49,49,39,32,116,121,112,101,61,39,115,101,116,39,62,60,113,117,101,114,121,32,120,109,108,110,115,61,39,106,97,98,98,101,114,58,105,113,58,114,111,115,116,101,114,39,62,60,105,116,101,109,32,115,117,98,115,99,114,105,112,116,105,111,110,61,39,110,111,110,101,39,32,106,105,100,61,39,49,50,49,48,52,56,64,97,98,45,105,110,115,117,114,97,110,99,101,46,99,111,109,39,62,60,103,114,111,117,112,62,230,136,145,231,154,132,229,165,189,229,143,139,60,47,103,114,111,117,112,62,60,47,105,116,101,109,62,60,47,113,117,101,114,121,62,60,47,105,113,62>>
2017-02-24 09:31:27.928 [debug] <0.511.0>@ejabberd_c2s:send_text:1949 Send XML on stream = <<60,105,113,32,102,114,111,109,61,39,49,55,54,57,50,54,64,97,98,45,105,110,115,117,114,97,110,99,101,46,99,111,109,39,32,116,111,61,39,49,55,54,57,50,54,64,97,98,45,105,110,115,117,114,97,110,99,101,46,99,111,109,47,72,105,115,117,112,101,114,39,32,105,100,61,39,112,117,115,104,55,50,53,49,52,57,50,52,55,56,51,55,50,48,57,52,49,49,39,32,116,121,112,101,61,39,115,101,116,39,62,60,113,117,101,114,121,32,120,109,108,110,115,61,39,106,97,98,98,101,114,58,105,113,58,114,111,115,116,101,114,39,62,60,105,116,101,109,32,115,117,98,115,99,114,105,112,116,105,111,110,61,39,110,111,110,101,39,32,106,105,100,61,39,49,50,49,48,52,56,64,97,98,45,105,110,115,117,114,97,110,99,101,46,99,111,109,39,62,60,103,114,111,117,112,62,230,136,145,231,154,132,229,165,189,229,143,139,60,47,103,114,111,117,112,62,60,47,105,116,101,109,62,60,47,113,117,101,114,121,62,60,47,105,113,62>>
2017-02-24 09:31:27.929 [debug] <0.511.0>@ejabberd_c2s:send_element:1969 796 StateData={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[{18,{1487,899887,923382},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}}],[]},1000,undefined,300000,300,60000,undefined,false,13,18,16,true,<<"zh-CN">>}, El={xmlel,<<"r">>,[{<<"xmlns">>,<<"urn:xmpp:sm:2">>}],[]}
2017-02-24 09:31:27.929 [debug] <0.511.0>@ejabberd_c2s:send_text:1948 797 StateData#state.sockmod=ejabberd_socket, StateData#state.socket={socket_state,gen_tcp,#Port<0.17740>,<0.510.0>}, Text=<<"<r xmlns='urn:xmpp:sm:2'/>">>
2017-02-24 09:31:27.929 [debug] <0.511.0>@ejabberd_c2s:send_text:1949 Send XML on stream = <<"<r xmlns='urn:xmpp:sm:2'/>">>
2017-02-24 09:31:27.930 [debug] <0.511.0>@ejabberd_c2s:handle_info:1744 787 SentStateData={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[{18,{1487,899887,923382},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}}],[]},1000,undefined,300000,300,60000,#Ref<0.0.4.1502>,false,13,18,18,true,<<"zh-CN">>}
2017-02-24 09:31:27.930 [debug] <0.511.0>@ejabberd_c2s:handle_info:1477 783 From={jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>},To={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},Packet={xmlel,<<"iq">>,[{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}],[]}
2017-02-24 09:31:27.931 [debug] <0.511.0>@ejabberd_c2s:handle_info:1731 785 Pass=true, NewAttrs=[{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}], NewState={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[{18,{1487,899887,923382},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}}],[]},1000,undefined,300000,300,60000,#Ref<0.0.4.1502>,false,13,18,18,true,<<"zh-CN">>}
2017-02-24 09:31:27.931 [debug] <0.511.0>@ejabberd_c2s:handle_info:1742 786 NewState={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[{18,{1487,899887,923382},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}}],[]},1000,undefined,300000,300,60000,#Ref<0.0.4.1502>,false,13,18,18,true,<<"zh-CN">>}, FixedPacket={xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}],[]}
2017-02-24 09:31:27.932 [debug] <0.511.0>@ejabberd_c2s:send_packet:1995 788 StateData={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[{18,{1487,899887,923382},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}}],[]},1000,undefined,300000,300,60000,#Ref<0.0.4.1502>,false,13,18,18,true,<<"zh-CN">>},Packet={xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}],[]}
2017-02-24 09:31:27.933 [debug] <0.511.0>@ejabberd_c2s:send_stanza:1981 793 StateData={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[{18,{1487,899887,923382},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}}],[]},1000,undefined,300000,300,60000,#Ref<0.0.4.1502>,false,13,18,18,true,<<"zh-CN">>},Stanza={xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}],[]}
2017-02-24 09:31:27.933 [debug] <0.511.0>@ejabberd_c2s:send_element:1969 796 StateData={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[{19,{1487,899887,933183},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}],[]}}],[{18,{1487,899887,923382},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,...}]}]}]}]}}]},...}, El={xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}],[]}
2017-02-24 09:31:27.933 [debug] <0.511.0>@ejabberd_c2s:send_text:1948 797 StateData#state.sockmod=ejabberd_socket, StateData#state.socket={socket_state,gen_tcp,#Port<0.17740>,<0.510.0>}, Text=<<"<iq from='176926@ab-insurance.com' to='176926@ab-insurance.com/Hisuper' id='F2F3509C0C1E4C3CA46576C414D42EC2' type='result'/>">>
2017-02-24 09:31:27.934 [debug] <0.511.0>@ejabberd_c2s:send_text:1949 Send XML on stream = <<"<iq from='176926@ab-insurance.com' to='176926@ab-insurance.com/Hisuper' id='F2F3509C0C1E4C3CA46576C414D42EC2' type='result'/>">>
2017-02-24 09:31:27.938 [debug] <0.511.0>@ejabberd_c2s:handle_info:1744 787 SentStateData={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[{19,{1487,899887,933183},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}],[]}}],[{18,{1487,899887,923382},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,<<230,136,145,231,154,132,229,165,189,229,143,139>>}]}]}]}]}}]},1000,undefined,300000,300,60000,#Ref<0.0.4.1502>,false,13,19,18,true,<<"zh-CN">>}
2017-02-24 09:31:28.068 [debug] <0.510.0>@ejabberd_receiver:process_data:284 Received XML on stream = <<"<r xmlns=\"urn:xmpp:sm:2\"/>">>
2017-02-24 09:31:28.068 [debug] <0.510.0>@shaper:update:120 State: {maxrate,1000,86.48023543124974,1487899887892237}, Size=26
M=13.58752623381427, I=176.637
2017-02-24 09:31:28.069 [debug] <0.511.0>@ejabberd_c2s:send_element:1969 796 StateData={state,{socket_state,gen_tcp,#Port<0.17740>,<0.510.0>},ejabberd_socket,#Ref<0.0.5.1562>,false,<<"3987851190562504994">>,undefined,c2s,c2s_shaper,false,false,false,false,[verify_none,compression_none],true,{jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,{{1487,899693,3},<0.511.0>},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{1,{{<<"176926">>,<<"ab-insurance.com">>,<<>>},nil,nil}},{xmlel,<<"presence">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"E20E845709C84FE580E1042B03AFFCE2">>}],[{xmlel,<<"x">>,[{<<"xmlns">>,<<"vcard-temp:x:update">>}],[{xmlel,<<"photo">>,[],[{xmlcdata,<<"null">>}]}]},{xmlel,<<"client">>,[{<<"xmlns">>,<<"http://www.nihualao.com/xmpp/client">>}],[{xmlel,<<"push">>,[{<<"type">>,<<"mipush">>},{<<"token">>,<<"i176926">>}],[]}]},{xmlel,<<"c">>,[{<<"xmlns">>,<<"http://jabber.org/protocol/caps">>},{<<"hash">>,<<"sha-1">>},{<<"node">>,<<"http://www.nihualao.com">>},{<<"ver">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>}],[]}]},{1487,899695,879421},{userlist,none,[],false},c2s,ejabberd_auth_sql,{{10,10,239,28},52010},[{caps_resources,{1,{{<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},{caps,<<"http://www.nihualao.com">>,<<"NT+z2qYKxxwpVTzECaomiTyRYqk=">>,<<"sha-1">>,[]},nil,nil}}}],active,active,<<"urn:xmpp:sm:2">>,{[{19,{1487,899887,933183},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"F2F3509C0C1E4C3CA46576C414D42EC2">>},{<<"type">>,<<"result">>}],[]}}],[{18,{1487,899887,923382},{xmlel,<<"iq">>,[{<<"from">>,<<"176926@ab-insurance.com">>},{<<"to">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"id">>,<<"push725149247837209411">>},{<<"type">>,<<"set">>}],[{xmlel,<<"query">>,[{<<"xmlns">>,<<"jabber:iq:roster">>}],[{xmlel,<<"item">>,[{<<"subscription">>,<<"none">>},{<<"jid">>,<<"121048@ab-insurance.com">>}],[{xmlel,<<"group">>,[],[{xmlcdata,...}]}]}]}]}}]},...}, El={xmlel,<<"a">>,[{<<"xmlns">>,<<"urn:xmpp:sm:2">>},{<<"h">>,<<"13">>}],[]}
2017-02-24 09:31:28.069 [debug] <0.511.0>@ejabberd_c2s:send_text:1948 797 StateData#state.sockmod=ejabberd_socket, StateData#state.socket={socket_state,gen_tcp,#Port<0.17740>,<0.510.0>}, Text=<<"<a xmlns='urn:xmpp:sm:2' h='13'/>">>
2017-02-24 09:31:28.069 [debug] <0.511.0>@ejabberd_c2s:send_text:1949 Send XML on stream = <<"<a xmlns='urn:xmpp:sm:2' h='13'/>">>
2017-02-24 09:31:28.709 [debug] <0.510.0>@ejabberd_receiver:process_data:284 Received XML on stream = <<"<iq id=\"push725149247837209411\" to=\"176926@ab-insurance.com\" from=\"176926@ab-insurance.com/Hisuper\" type=\"error\"><error code=\"501\" type=\"CANCEL\"><feature-not-implemented xmlns=\"urn:ietf:params:xml:ns:xmpp-stanzas\"/></error></iq>">>
2017-02-24 09:31:28.709 [debug] <0.510.0>@shaper:update:120 State: {maxrate,1000,116.8003182520485,1487899888068963}, Size=228
M=121.07053872713837, I=640.419
2017-02-24 09:31:28.709 [debug] <0.511.0>@ejabberd_router:do_route:352 route
        from {jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
        to {jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}
        packet {xmlel,<<"iq">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"push725149247837209411">>},{<<"to">>,<<"176926@ab-insurance.com">>},{<<"from">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"type">>,<<"error">>}],[{xmlel,<<"error">>,[{<<"code">>,<<"501">>},{<<"type">>,<<"CANCEL">>}],[{xmlel,<<"feature-not-implemented">>,[{<<"xmlns">>,<<"urn:ietf:params:xml:ns:xmpp-stanzas">>}],[]}]}]}
2017-02-24 09:31:28.709 [debug] <0.511.0>@ejabberd_router:do_route:376 773 From={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}, To={jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}, Packet={xmlel,<<"iq">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"push725149247837209411">>},{<<"to">>,<<"176926@ab-insurance.com">>},{<<"from">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"type">>,<<"error">>}],[{xmlel,<<"error">>,[{<<"code">>,<<"501">>},{<<"type">>,<<"CANCEL">>}],[{xmlel,<<"feature-not-implemented">>,[{<<"xmlns">>,<<"urn:ietf:params:xml:ns:xmpp-stanzas">>}],[]}]}]}
2017-02-24 09:31:28.710 [debug] <0.511.0>@ejabberd_router:do_route:381 775 R={route,<<"ab-insurance.com">>,<<"ab-insurance.com">>,<0.348.0>,{apply,ejabberd_local,route}}
2017-02-24 09:31:28.710 [debug] <0.511.0>@ejabberd_local:do_route:266 local route
        from {jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
        to {jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}
        packet {xmlel,<<"iq">>,[{<<"xml:lang">>,<<"zh-C"...>>},{<<"id">>,<<...>>},{<<...>>,...},{...}|...],[{xmlel,<<...>>,...}]}
2017-02-24 09:31:28.710 [debug] <0.511.0>@ejabberd_local:do_route:270 781 From={jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>},To={jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>},Packet={xmlel,<<"iq">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"push725149247837209411">>},{<<"to">>,<<"176926@ab-insurance.com">>},{<<"from">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"type">>,<<"error">>}],[{xmlel,<<"error">>,[{<<"code">>,<<"501">>},{<<"type">>,<<"CANCEL">>}],[{xmlel,<<"feature-not-implemented">>,[{<<"xmlns">>,<<"urn:ietf:params:xml:ns:xmpp-stanzas">>}],[]}]}]}
2017-02-24 09:31:28.710 [debug] <0.511.0>@ejabberd_sm:do_route:466 session manager
        from {jid,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>,<<"176926">>,<<"ab-insurance.com">>,<<"Hisuper">>}
        to {jid,<<"176926">>,<<"ab-insurance.com">>,<<>>,<<"176926">>,<<"ab-insurance.com">>,<<>>}
        packet {xmlel,<<"iq">>,[{<<"xml:lang">>,<<"zh-C"...>>},{<<"id">>,<<...>>},{<<...>>,...},{...}|...],[{xmlel,<<...>>,...}]}
2017-02-24 09:31:28.710 [debug] <0.511.0>@ejabberd_sm:do_route:469 781 Packet={xmlel,<<"iq">>,[{<<"xml:lang">>,<<"zh-CN">>},{<<"id">>,<<"push725149247837209411">>},{<<"to">>,<<"176926@ab-insurance.com">>},{<<"from">>,<<"176926@ab-insurance.com/Hisuper">>},{<<"type">>,<<"error">>}],[{xmlel,<<"error">>,[{<<"code">>,<<"501">>},{<<"type">>,<<"CANCEL">>}],[{xmlel,<<"feature-not-implemented">>,[{<<"xmlns">>,<<"urn:ietf:params:xml:ns:xmpp-stanzas">>}],[]}]}]}
2017-02-24 09:31:28.710 [debug] <0.511.0>@ejabberd_sm:process_iq:744 1001 IQ=reply

5 IQType=~p, Name=~p~n", [IQType, Name]),
		    {error, ?ERR_FEATURE_NOT_IMPLEMENTED}
	    end;
	_ ->
