...
init([Host, Opts]) ->
    ...
    RoomShaper = gen_mod:get_opt(room_shaper, Opts,
                                 ...
                                 none),
    Extra = #state{host = MyHost, server_host = Host,
		access = {Access, AccessCreate, AccessAdmin, AccessPersistent},
		default_room_opts = DefRoomOpts, history_size = HistorySize,
		room_shaper = RoomShaper},
    ejabberd_router:register_route2(MyHost, Host, Extra),
